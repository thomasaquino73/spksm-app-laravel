    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive" style="padding: 20px">
                ...
                <form method="POST" action="{{ route('galeri.update', $galeri->id) }}" class="py-2" id="postForm"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @php
                                        ...
                                        if (isset($galeri->kategori_berita_id)) {
                                            $selectedKategori = is_array($galeri->kategori_berita_id)
                                                ? $galeri->kategori_berita_id
                                                : json_decode($galeri->kategori_berita_id, true);
                                        }
                                    @endphp
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="3" class="form-control">{{ $galeri->description }}</textarea>
