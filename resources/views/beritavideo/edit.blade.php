    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive" style="padding: 20px">
                ...
                <form method="POST" action="{{ route('berita-video.update', $video->id) }}" class="py-2" id="postForm"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="judul" id="judul" class="form-control"
                                        value="{{ $video->judul }}">
                                    <span class="error text-danger" id="judulError"></span>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <span class="error text-danger" id="youtube_idError"></span>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    @php
                                        ...
                                        if (isset($video->kategori_berita_id)) {
                                            $selectedKategori = is_array($video->kategori_berita_id)
                                                ? $video->kategori_berita_id
                                                : json_decode($video->kategori_berita_id, true);
                                        }
                                    @endphp
                                    <select name="kategori_berita_id[]" id="kategori_berita_id" class="form-select select2"
                                        ...
                                        @foreach ($kategori as $k)
                                            <option value="{{ $k->id }}"
                                                {{ in_array($k->id, $selectedKategori ?? []) ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="keyword" id="keyword" class="form-control"
                                        value="{{ old('keyword', $video->keyword) }}"placeholder="Enter the Hastag...">
                                    <span class="error text-danger" id="keywordError"></span>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Deskripsi</label>
                                    <textarea name="deskripsi" id="deskripsi" cols="30" rows="3" class="form-control">{{ old('deskripsi', $video->deskripsi) }}</textarea>
                                    <span class="error text-danger" id="deskripsiError"></span>
                                </div>
